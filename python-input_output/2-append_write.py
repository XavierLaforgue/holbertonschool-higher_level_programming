...
Contains function that writes to a file appending to its content.
"""


def append_write(filename="", text=""):
    """Write text into a file appending to its content.

    Args:
        filename (str): name of the file to write the text on.
        text (str): text to append to the content of the file.
    """
