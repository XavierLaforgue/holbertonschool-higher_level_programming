...
Contains function that writes an Object to a text file, using a JSON
representation.
"""
import json
...
def save_to_json_file(my_obj, filename):
    ...
    Args:
        my_obj (obj): object to save in json representation.
        filename (str): name of file where the object will be stored.
    """
