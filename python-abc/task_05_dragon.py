#!/usr/bin/python3
"""
Module Name: task_05_dragon.

Contains a class that inherits from other two classes and inherits
their behaviors.
"""


class SwimMixin:
    """Allows anyone to swim."""

    def swim(self):
        """Define what is to swim."""
        print("The creature swims!")


class FlyMixin:
    """Allows anyone to fly."""

    def fly(self):
        """Define what is to fly."""
