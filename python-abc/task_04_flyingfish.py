#!/usr/bin/python3
"""
Module Name: task_04_flyingfish.

Contains a class with multpiple inheritance (inherits from multiple
classes).
"""
...
class Fish:
    ...
    def swim(self):
        """Allow the Fish to swim."""
        print("The fish is swimming")

    def habitat(self):
        """Define where the Fish lives."""
...
class Bird:
    ...
    def habitat(self):
        """Define where the Bird lives."""
        print("The bird lives in the sky")


class FlyingFish(Fish, Bird):
    """Define a FlyingFish with attributes from both Fish and Bird."""

    def fly(self):
        """Allow the FlyingFish to fly."""
        print("The flying fish is soaring!")

    def swim(self):
        """Allow the FlyingFish to swim."""
        print("The flying fish is swimming!")

    def habitat(self):
        """Define where the FlyingFish lives."""
