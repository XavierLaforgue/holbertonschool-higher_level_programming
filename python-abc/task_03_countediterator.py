#!/usr/bin/python3
"""
Module Name: task_03_countediterator.

Contains a class that extends the iterable class to keep track of the
iteration.
"""


class CountedIterator:
    """Define extension of iterator that counts iterations.

    Examples:
    >>> counted_iter = CountedIterator([0, 2, 3, 6])
