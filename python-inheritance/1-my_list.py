...
Define a class MyList as a subclass of list that can print the list in
ascending order.
"""


class MyList(list):
    """Define a subclass of list that can print itself sorted."""
...
if __name__ == "__main__":
    ...
    test_file_path = "tests/1-my_list.txt"
